...
def addToDatabaseLabels() -> None:
    def addToDatabaseGate() -> None:
        ...
        addToTable(event_name, begin_date, time, end_time, recurs, last_reccurance, type_of_event, description)
    ...
    window.create_window(74, 150, window=recurs_text)  
    recurs_input = tk.Entry(root) 
    window.create_window(200, 150, window=recurs_input)

    last_reccurance_text = tk.Label(root, text = "Last Recurrance:")
    window.create_window(46, 175, window=last_reccurance_text)  
    last_reccurance_input = tk.Entry(root) 
    window.create_window(200, 175, window=last_reccurance_input)
